module.exports = {
  paths: {
    "/posts/getAll": {
      //FULL path after port (from index + endpoint)
      get: {
        //CRUD
        tags: {
          Posts: "Get Tasks",
        ...
        description:
          "Get tasks populated with Usernames and Comments from their respective collections",
    ...
    "/posts/getAllWithLikesAndComments": {
      //FULL path after port (from index + endpoint)
      get: {
        //CRUD
        tags: {
        ...
        description:
          "Get tasks with all relevant information from other collections too.",
    ...
    "/posts/getAndLimit": {
      get: {
        ...
        description:
          "Shows 10 tasks at a time. Query parameters can be used to change the number of tasks returned and number of tasks skipped.",
    ...
    "/posts/getById/{_id}": {
      get: {
        ...
        responses: {
          200: {
            description:
              "One post populated with information from Users and Comments collections",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/post",
    ...
    "/posts/getUsersPosts/{userId}": {
      get: {
        ...
        responses: {
          200: {
            description:
              "All posts populated with information from Users and Comments collections. Sorted from newest to oldest.",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/post",
    ...
    "/posts/FriendsPosts": {
      get: {
        ...
        description:
          "Gets the posts of the people the user is following. User must be logged in",
    ...
    "/posts/update/{_id}": {
      put: {
        ...
        description:
          "Update post by Id - Note that a middleware is used to check if the user's id matches the post's creator's id (isAuthor).",
    ...
    "/posts/delete/{_id}": {
      put: {
        ...
        description:
          "Delete post by Id - Note that a middleware is used to check if the user's id matches the post's creator's id (isAuthor).",
